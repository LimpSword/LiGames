...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public List<Location> getLocation() {
        ...
        return copy.stream().map(Block::getLocation).collect(Collectors.toList());
    }
    ...
    /**
     * Check if the given player is contained within this Cuboid.
     *
    ...
    public Location getRandomLocationOutdoor() {
        Random random = new Random();
        int x = random.nextInt(this.getSizeX());
        int z = random.nextInt(this.getSizeZ());

        int maxY = this.getWorld().getHighestBlockAt(this.getLowerX() + x, this.getLowerZ() + z).getY() + 5;
        int y = random.nextInt(maxY - this.getLowerY()) + this.getLowerY();

        Location location = new Location(this.getWorld(), this.getLowerX() + x, y, this.getLowerZ() + z);
        while (location.getBlock().getType() != Material.AIR) {
            x = random.nextInt(this.getSizeX());
            y = random.nextInt(this.getSizeY());
            z = random.nextInt(this.getSizeZ());
            location = new Location(this.getWorld(), this.getLowerX() + x, this.getLowerY() + y, this.getLowerZ() + z);
        }
        return location;
    }

    public Location getRandomBlockLocationOutdoor() {
        Random random = new Random();
        int x = random.nextInt(this.getSizeX());
        int z = random.nextInt(this.getSizeZ());
        ...
        Location location = new Location(this.getWorld(), this.getLowerX() + x, y, this.getLowerZ() + z);
        Material topType = location.clone().add(0, 1, 0).getBlock().getType();
        while (!topType.isTransparent()) {
            x = random.nextInt(this.getSizeX());
            y = random.nextInt(this.getSizeY());
            z = random.nextInt(this.getSizeZ());
            location = new Location(this.getWorld(), this.getLowerX() + x, this.getLowerY() + y, this.getLowerZ() + z);
            topType = location.clone().add(0,1,0).getBlock().getType();
        }
        return location;
    }
